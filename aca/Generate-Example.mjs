...
import { transformSync } from "../intent-to-impact-studio/apps/experience/node_modules/esbuild/lib/main.js";

const source = fileURLToPath(new URL("../intent-to-impact-studio/apps/experience/src/business/model.ts", import.meta.url));
