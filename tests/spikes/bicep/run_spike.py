...
OWNED_ROOT = WORKSPACE / ".intent-to-impact" / "spikes" / "SPK-04-01"
...
def main():
    ...
    for path in [WORKSPACE / ".intent-to-impact", OWNED_ROOT.parent, OWNED_ROOT, run_directory]:
    ...
    print(json.dumps({
        ...
        "receipt": str((run_directory / "receipt.json").relative_to(WORKSPACE)),
        "commandOutcomes": [
