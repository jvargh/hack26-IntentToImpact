...
REPO = WORKSPACE.parent if WORKSPACE.name == "intent-to-impact-studio" else WORKSPACE
...
def _build_dir(output_root: Path, build_id: str) -> Path:
    ...
    approved = [
        REPO / ".intent-to-impact" / "studio" / "builds",
        REPO / ".intent-to-impact" / "studio" / "runs" / "builds",
        REPO / ".intent-to-impact" / "spikes" / "STUDIO-BUNDLE",
        WORKSPACE / ".intent-to-impact" / "studio" / "builds",
        WORKSPACE / ".intent-to-impact" / "studio" / "runs" / "builds",
        WORKSPACE / ".intent-to-impact" / "spikes" / "STUDIO-BUNDLE",
    ]
