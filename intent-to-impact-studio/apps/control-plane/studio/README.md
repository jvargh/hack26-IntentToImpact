...
[technical deep dive](../../../../docs/intent-to-impact-technical-deep-dive.md), and
[numbered user guide](../../../../docs/intent-to-impact-user-guide.md).
...
$env:PYTHONPATH = (Resolve-Path .\intent-to-impact-studio\apps\control-plane).Path
...
.\.intent-to-impact\studio\.venv` if absent. Build `intent-to-impact-studio\apps\experience` using its
...
```powershell
& .\.intent-to-impact\studio\.venv\Scripts\python.exe -m unittest discover -s .\intent-to-impact-studio\tests\studio -p "test_design_changes.py" -v
```
...
```powershell
& .\.intent-to-impact\studio\.venv\Scripts\python.exe -m unittest discover -s .\intent-to-impact-studio\tests\studio -p "test_*.py"
& .\.intent-to-impact\studio\.venv\Scripts\python.exe .\intent-to-impact-studio\apps\control-plane\studio\live_smoke.py
```
