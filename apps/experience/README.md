...
The [numbered user guide](../../intent-to-impact-user-guide.md) is the maintained
...
`tests\experience\design_change_browser.py --execute-live --parent-job <saved-example-job> --build`
...
See the [numbered user guide](../../intent-to-impact-user-guide.md) for complete
...
`apps\control-plane\studio\studio.schema.json`. Types and **static, CSP-safe**
...
[user guide](../../intent-to-impact-user-guide.md#recorded-verification---14-september-2026).
...
```powershell
& .\.intent-to-impact\spikes\UI-01-01\browser\.venv\Scripts\python.exe -B .\tests\experience\live_studio_browser.py --execute-live
& .\.intent-to-impact\studio\.venv\Scripts\python.exe -B .\tests\studio\live_smoke.py --execute-live --refine
```
...
```powershell
& .\.intent-to-impact\spikes\UI-01-01\browser\.venv\Scripts\python.exe -B .\tests\experience\live_studio_browser.py --execute-live --example --build
```
...
```powershell
& .\.intent-to-impact\spikes\UI-01-01\browser\.venv\Scripts\python.exe -B .\tests\experience\canvas_zoom_browser.py
```
