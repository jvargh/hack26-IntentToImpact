...
|---|---|---|
| Workflow sequencing, admission, jobs and builds | [StudioService](../intent-to-impact-studio/apps/control-plane/studio/service.py) | Creates and persists local execution records; calls the model and package builder |
| Bounded model interaction | [FoundryModelClient](../intent-to-impact-studio/apps/control-plane/studio/model_client.py) | Calls the existing configured model; does not approve or deploy |
| Model-facing structured output | [generation_schema.py](../intent-to-impact-studio/apps/control-plane/studio/generation_schema.py) | Derives strict output schemas from the canonical contract |
| Input, source and graph validation | [validation.py](../intent-to-impact-studio/apps/control-plane/studio/validation.py) | Accepts or rejects structural and relationship claims |
| Contextual revision authorization | [design_changes.py](../intent-to-impact-studio/apps/control-plane/studio/design_changes.py) | Binds human direction to an exact prior result, option and finding |
| Infrastructure compilation | [bundle.py](../intent-to-impact-studio/apps/control-plane/studio/bundle.py) and [templates](../intent-to-impact-studio/apps/control-plane/studio/templates) | Maps supported component/edge types to fixed infrastructure rules |
...
The repository also contains earlier [state](../intent-to-impact-studio/apps/control-plane/state), [policy](../intent-to-impact-studio/apps/control-plane/policy), and [work](../intent-to-impact-studio/apps/control-plane/work) foundations. Their presence does **not** mean the live studio currently runs through that entire architecture.
...
The [studio schema](../intent-to-impact-studio/apps/control-plane/studio/studio.schema.json) is the shared language between AI, backend, frontend, and builder.
...
[generate-studio.mjs](../intent-to-impact-studio/apps/experience/scripts/generate-studio.mjs) derives the browser TypeScript declarations and static validators from the canonical schema.
...
| Strict provider format | [generation_schema.py](../intent-to-impact-studio/apps/control-plane/studio/generation_schema.py) |
| Source/reference validation | [validation.py](../intent-to-impact-studio/apps/control-plane/studio/validation.py) |
| Revision permission binding | [design_changes.py](../intent-to-impact-studio/apps/control-plane/studio/design_changes.py) |
| Infrastructure compiler boundary | [bundle.py](../intent-to-impact-studio/apps/control-plane/studio/bundle.py) |
| Catalog and integration contracts | [Template README](../intent-to-impact-studio/apps/control-plane/studio/templates/README.md) |
| UI current-result and operation handling | [StudioApp.tsx](../intent-to-impact-studio/apps/experience/src/studio/StudioApp.tsx) |
| Approval and before/after presentation | [DesignChange.tsx](../intent-to-impact-studio/apps/experience/src/studio/views/DesignChange.tsx) |
| Azure handoff hash checks and instructions | [deployment.ts](../intent-to-impact-studio/apps/experience/src/studio/deployment.ts) and [DeploymentPanel.tsx](../intent-to-impact-studio/apps/experience/src/studio/views/DeploymentPanel.tsx) |
| Layout and routes | [graphLayout.ts](../intent-to-impact-studio/apps/experience/src/studio/views/graphLayout.ts) |
| Graph interaction and camera | [ArchitectureCanvas.tsx](../intent-to-impact-studio/apps/experience/src/studio/views/ArchitectureCanvas.tsx) |
...
The same helper is executable directly as `.\intent-to-impact-studio\tools\Stop-LiveStudioPort.ps1`
